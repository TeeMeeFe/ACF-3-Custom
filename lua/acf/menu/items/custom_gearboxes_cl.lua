...
ACF.Menu.RegisterPage({
	ID       = "acf_gearbox_custom",
	Category = "#acf.menu.entities",
	Name     = "Custom Gearboxes",
	Icon     = "cog_add",
	Order    = 302,

	Contexts = { Gearbox = "acf_gearbox_custom" },

	Actions = {
		{ Bind = "left",  Context = "Gearbox", Preview = true, Desc = "Spawn a new custom gearbox, or update the one you're aiming at." },
		{ Bind = "right", Commit = "link", Desc = "Select entities, then a custom gearbox, to link them (hold R to unlink)." },
	},
